...
umain(void)
{
  ...
  800037:	83 ec 18             	sub    $0x18,%esp
	cprintf("1/0 is %08x!\n", 1/zero);
  80003a:	ba 01 00 00 00       	mov    $0x1,%edx
  80003f:	89 d0                	mov    %edx,%eax
  800041:	c1 fa 1f             	sar    $0x1f,%edx
  800044:	f7 3d 04 20 80 00    	idivl  0x802004
  80004a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80004e:	c7 04 24 98 0e 80 00 	movl   $0x800e98,(%esp)
  800055:	e8 c7 00 00 00       	call   800121 <cprintf>
}
  80005a:	c9                   	leave  
  80005b:	c3                   	ret    
...
//	env = &envs[ENVX(sys_getenvid())];
        env = envs + ENVX(sys_getenvid ());
  80006e:	e8 85 0b 00 00       	call   800bf8 <sys_getenvid>
  800073:	25 ff 03 00 00       	and    $0x3ff,%eax
  800078:	6b c0 64             	imul   $0x64,%eax,%eax
...
exit(void)
{
  ...
  8000b9:	e8 05 0b 00 00       	call   800bc3 <sys_env_destroy>
}
  8000be:	c9                   	leave  
  8000bf:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8000fc:	e8 cf 01 00 00       	call   8002d0 <vprintfmt>
  ...
  800114:	e8 43 0a 00 00       	call   800b5c <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800168:	e8 ef 09 00 00       	call   800b5c <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800261:	0f be 80 bd 0e 80 00 	movsbl 0x800ebd(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800348:	ff 24 95 4c 0f 80 00 	jmp    *0x800f4c(,%edx,4)
  ...
  80044d:	c7 44 24 08 d7 0e 80 	movl   $0x800ed7,0x8(%esp)
  800454:	00 
  ...
  800488:	b8 da 0e 80 00       	mov    $0x800eda,%eax
