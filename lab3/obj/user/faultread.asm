	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800261:	0f be 80 cd 0e 80 00 	movsbl 0x800ecd(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800348:	ff 24 95 5c 0f 80 00 	jmp    *0x800f5c(,%edx,4)
  ...
  80044d:	c7 44 24 08 e7 0e 80 	movl   $0x800ee7,0x8(%esp)
  800454:	00 
  ...
  800488:	b8 ea 0e 80 00       	mov    $0x800eea,%eax
