...
umain(void)
{
  ...
  800043:	c7 04 24 a0 10 80 00 	movl   $0x8010a0,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  800075:	8d 84 c2 00 00 c0 ee 	lea    -0x11400000(%edx,%eax,8),%eax
...
exit(void)
{
  ...
  8000b5:	e8 09 0b 00 00       	call   800bc3 <sys_env_destroy>
}
  8000ba:	c9                   	leave  
  8000bb:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8000f8:	e8 d3 01 00 00       	call   8002d0 <vprintfmt>
  ...
  800110:	e8 47 0a 00 00       	call   800b5c <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800164:	e8 f3 09 00 00       	call   800b5c <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001fd:	e8 1e 0c 00 00       	call   800e20 <__udivdi3>
  ...
  800258:	e8 f3 0c 00 00       	call   800f50 <__umoddi3>
  80025d:	89 74 24 04          	mov    %esi,0x4(%esp)
  800261:	0f be 80 d5 10 80 00 	movsbl 0x8010d5(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80044d:	c7 44 24 08 ef 10 80 	movl   $0x8010ef,0x8(%esp)
  800454:	00 
  ...
  800488:	b8 f2 10 80 00       	mov    $0x8010f2,%eax
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cbe:	8b 1c 24             	mov    (%esp),%ebx
  800cc1:	8b 74 24 04          	mov    0x4(%esp),%esi
  800cc5:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800cc9:	89 ec                	mov    %ebp,%esp
  800ccb:	5d                   	pop    %ebp
  800ccc:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cda:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d0c:	89 74 24 04          	mov    %esi,0x4(%esp)
  800d10:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d2a:	8b 1c 24             	mov    (%esp),%ebx
  800d2d:	8b 74 24 04          	mov    0x4(%esp),%esi
  800d31:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800d35:	89 ec                	mov    %ebp,%esp
  800d37:	5d                   	pop    %ebp
  800d38:	c3                   	ret    

00800d39 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d46:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d7c:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800dab:	89 1c 24             	mov    %ebx,(%esp)
  800dae:	89 74 24 04          	mov    %esi,0x4(%esp)
  800db2:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_ipc_recv(void *dstva)
{
  ...
  800df3:	b8 0d 00 00 00       	mov    $0xd,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800e03:	8b 1c 24             	mov    (%esp),%ebx
  800e06:	8b 74 24 04          	mov    0x4(%esp),%esi
