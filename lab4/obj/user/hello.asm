...
libmain(int argc, char **argv)
{
  ...
  800081:	8d 84 c2 00 00 c0 ee 	lea    -0x11400000(%edx,%eax,8),%eax
...
exit(void)
{
  ...
  8000c1:	e8 0d 0b 00 00       	call   800bd3 <sys_env_destroy>
}
  8000c6:	c9                   	leave  
  8000c7:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800104:	e8 d7 01 00 00       	call   8002e0 <vprintfmt>
  ...
  80011c:	e8 4b 0a 00 00       	call   800b6c <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800170:	e8 f7 09 00 00       	call   800b6c <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80020d:	e8 1e 0c 00 00       	call   800e30 <__udivdi3>
  ...
  800271:	0f be 80 dc 10 80 00 	movsbl 0x8010dc(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800358:	ff 24 95 a0 11 80 00 	jmp    *0x8011a0(,%edx,4)
  ...
  80045d:	c7 44 24 08 f6 10 80 	movl   $0x8010f6,0x8(%esp)
  800464:	00 
  ...
  800498:	b8 f9 10 80 00       	mov    $0x8010f9,%eax
...
sys_yield(void)
{
  ...
  800c45:	89 74 24 04          	mov    %esi,0x4(%esp)
  800c49:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_yield(void)
{
  ...
  800c64:	8b 74 24 04          	mov    0x4(%esp),%esi
  800c68:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800c6c:	89 ec                	mov    %ebp,%esp
  800c6e:	5d                   	pop    %ebp
  800c6f:	c3                   	ret    
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c79:	89 74 24 04          	mov    %esi,0x4(%esp)
  800c7d:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cce:	8b 1c 24             	mov    (%esp),%ebx
  800cd1:	8b 74 24 04          	mov    0x4(%esp),%esi
  800cd5:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800cd9:	89 ec                	mov    %ebp,%esp
  800cdb:	5d                   	pop    %ebp
  800cdc:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cea:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d73:	8b 74 24 04          	mov    0x4(%esp),%esi
  800d77:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d8c:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800dbb:	89 1c 24             	mov    %ebx,(%esp)
  800dbe:	89 74 24 04          	mov    %esi,0x4(%esp)
  800dc2:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800dde:	8b 1c 24             	mov    (%esp),%ebx
  800de1:	8b 74 24 04          	mov    0x4(%esp),%esi
  800de5:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  800df3:	89 1c 24             	mov    %ebx,(%esp)
  800df6:	89 74 24 04          	mov    %esi,0x4(%esp)
  800dfa:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800e03:	b8 0d 00 00 00       	mov    $0xd,%eax
...
sys_ipc_recv(void *dstva)
{
  ...
  800e13:	8b 1c 24             	mov    (%esp),%ebx
  800e16:	8b 74 24 04          	mov    0x4(%esp),%esi
...
00800e30 <__udivdi3>:
  ...
  800e41:	8b 7d 0c             	mov    0xc(%ebp),%edi
  800e44:	85 c0                	test   %eax,%eax
  800e46:	89 55 f0             	mov    %edx,-0x10(%ebp)
  800e49:	75 35                	jne    800e80 <__udivdi3+0x50>
  800e4b:	39 fe                	cmp    %edi,%esi
  800e4d:	77 61                	ja     800eb0 <__udivdi3+0x80>
  800e4f:	85 f6                	test   %esi,%esi
  800e51:	75 0b                	jne    800e5e <__udivdi3+0x2e>
  800e53:	b8 01 00 00 00       	mov    $0x1,%eax
  800e58:	31 d2                	xor    %edx,%edx
  800e5a:	f7 f6                	div    %esi
  800e5c:	89 c6                	mov    %eax,%esi
  800e5e:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  800e61:	31 d2                	xor    %edx,%edx
  800e63:	89 f8                	mov    %edi,%eax
  800e65:	f7 f6                	div    %esi
  ...
  800e82:	77 1c                	ja     800ea0 <__udivdi3+0x70>
  800e84:	0f bd d0             	bsr    %eax,%edx
  800e87:	83 f2 1f             	xor    $0x1f,%edx
  800e8a:	89 55 f4             	mov    %edx,-0xc(%ebp)
  800e8d:	75 39                	jne    800ec8 <__udivdi3+0x98>
  800e8f:	3b 75 f0             	cmp    -0x10(%ebp),%esi
  800e92:	0f 86 a0 00 00 00    	jbe    800f38 <__udivdi3+0x108>
  800e98:	39 f8                	cmp    %edi,%eax
  800e9a:	0f 82 98 00 00 00    	jb     800f38 <__udivdi3+0x108>
  800ea0:	31 ff                	xor    %edi,%edi
  800ea2:	31 c9                	xor    %ecx,%ecx
  ...
  800eb4:	89 c8                	mov    %ecx,%eax
  800eb6:	31 ff                	xor    %edi,%edi
  ...
  800f1b:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  800f1f:	d3 e2                	shl    %cl,%edx
  800f21:	39 c2                	cmp    %eax,%edx
  800f23:	73 05                	jae    800f2a <__udivdi3+0xfa>
  800f25:	3b 75 ec             	cmp    -0x14(%ebp),%esi
  800f28:	74 1e                	je     800f48 <__udivdi3+0x118>
  800f2a:	89 f9                	mov    %edi,%ecx
  800f2c:	31 ff                	xor    %edi,%edi
  800f2e:	e9 71 ff ff ff       	jmp    800ea4 <__udivdi3+0x74>
  800f33:	90                   	nop
  800f34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800f38:	31 ff                	xor    %edi,%edi
  800f3a:	b9 01 00 00 00       	mov    $0x1,%ecx
  800f3f:	e9 60 ff ff ff       	jmp    800ea4 <__udivdi3+0x74>
  800f44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800f48:	8d 4f ff             	lea    -0x1(%edi),%ecx
...
00800f60 <__umoddi3>:
  ...
  800f68:	8b 55 14             	mov    0x14(%ebp),%edx
  800f6b:	8b 4d 08             	mov    0x8(%ebp),%ecx
  800f6e:	8b 7d 10             	mov    0x10(%ebp),%edi
  800f71:	8b 75 0c             	mov    0xc(%ebp),%esi
  800f74:	85 d2                	test   %edx,%edx
  800f76:	89 c8                	mov    %ecx,%eax
  800f78:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  800f7b:	75 13                	jne    800f90 <__umoddi3+0x30>
  800f7d:	39 f7                	cmp    %esi,%edi
  800f7f:	76 3f                	jbe    800fc0 <__umoddi3+0x60>
  800f81:	89 f2                	mov    %esi,%edx
  800f83:	f7 f7                	div    %edi
  ...
  800f92:	77 4c                	ja     800fe0 <__umoddi3+0x80>
  800f94:	0f bd ca             	bsr    %edx,%ecx
  800f97:	83 f1 1f             	xor    $0x1f,%ecx
  800f9a:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  800f9d:	75 51                	jne    800ff0 <__umoddi3+0x90>
  800f9f:	3b 7d f4             	cmp    -0xc(%ebp),%edi
  800fa2:	0f 87 e0 00 00 00    	ja     801088 <__umoddi3+0x128>
  800fa8:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800fab:	29 f8                	sub    %edi,%eax
  800fad:	19 d6                	sbb    %edx,%esi
  ...
  800ff0:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  800ff4:	d3 e2                	shl    %cl,%edx
  800ff6:	89 55 f4             	mov    %edx,-0xc(%ebp)
  800ff9:	ba 20 00 00 00       	mov    $0x20,%edx
  800ffe:	2b 55 f0             	sub    -0x10(%ebp),%edx
  801001:	89 55 ec             	mov    %edx,-0x14(%ebp)
  801004:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801008:	89 fa                	mov    %edi,%edx
  80100a:	d3 ea                	shr    %cl,%edx
  80100c:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801010:	0b 55 f4             	or     -0xc(%ebp),%edx
  801013:	d3 e7                	shl    %cl,%edi
  801015:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801019:	89 55 f4             	mov    %edx,-0xc(%ebp)
  80101c:	89 f2                	mov    %esi,%edx
  80101e:	89 7d e8             	mov    %edi,-0x18(%ebp)
  801021:	89 c7                	mov    %eax,%edi
  801023:	d3 ea                	shr    %cl,%edx
  801025:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801029:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  80102c:	89 c2                	mov    %eax,%edx
  80102e:	d3 e6                	shl    %cl,%esi
  801030:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801034:	d3 ea                	shr    %cl,%edx
  801036:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  ...
  801045:	f7 75 f4             	divl   -0xc(%ebp)
  801048:	89 d6                	mov    %edx,%esi
  80104a:	f7 65 e8             	mull   -0x18(%ebp)
  80104d:	39 d6                	cmp    %edx,%esi
  80104f:	72 2b                	jb     80107c <__umoddi3+0x11c>
  801051:	39 c7                	cmp    %eax,%edi
  801053:	72 23                	jb     801078 <__umoddi3+0x118>
  801055:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801059:	29 c7                	sub    %eax,%edi
  80105b:	19 d6                	sbb    %edx,%esi
  80105d:	89 f0                	mov    %esi,%eax
  80105f:	89 f2                	mov    %esi,%edx
  801061:	d3 ef                	shr    %cl,%edi
  801063:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801067:	d3 e0                	shl    %cl,%eax
  801069:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  80106d:	09 f8                	or     %edi,%eax
  ...
  801076:	5d                   	pop    %ebp
  801077:	c3                   	ret    
  801078:	39 d6                	cmp    %edx,%esi
  80107a:	75 d9                	jne    801055 <__umoddi3+0xf5>
  80107c:	2b 45 e8             	sub    -0x18(%ebp),%eax
  80107f:	1b 55 f4             	sbb    -0xc(%ebp),%edx
  801082:	eb d1                	jmp    801055 <__umoddi3+0xf5>
  801084:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801088:	39 f2                	cmp    %esi,%edx
  80108a:	0f 82 18 ff ff ff    	jb     800fa8 <__umoddi3+0x48>
  801090:	e9 1d ff ff ff       	jmp    800fb2 <__umoddi3+0x52>
